...
/**
 * Klasa poziomu 1 trybu średniego binarnego, zawiera całą mechanikę gry
 * przekazuje zmienną z punktami do kolejnej aktywności poziomu 2*/
public class Sredni extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sredni);
...
//            startActivity(intent);
            Intent myIntent = new Intent(Sredni.this, Sredni2.class);
