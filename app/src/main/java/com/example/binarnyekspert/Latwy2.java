...
/**
 * Klasa poziomu 2 trybu łatwego binarnego, zawiera całą mechanikę gry
 * pobiera zmienną z punktami z poziomu 1 i przekazuje do kolejnej aktywności poziomu 3 z dodanymi punktami za ten poziom */
public class Latwy2 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_latwy2);
        ...
        bt1_6.setText(Integer.toString(rand.nextInt(12)+1)); //MAX 15
        bt2_6.setText(Integer.toString(rand.nextInt(12)+1));
        bt3_6.setText(Integer.toString(rand.nextInt(12)+1));
        bt4_6.setText(Integer.toString(rand.nextInt(12)+1));
        bt5_6.setText(Integer.toString(rand.nextInt(12)+1));
...
//            startActivity(intent);
            Intent myIntent = new Intent(Latwy2.this, Latwy3.class);
