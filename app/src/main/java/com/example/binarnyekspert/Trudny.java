...
public class Trudny extends AppCompatActivity implements View.OnClickListener {
    ...
    private Button bt5_1, bt5_2, bt5_3, bt5_4, bt5_5, bt5_6, bt5_7;
    int licznik=0;
    int pkt=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt1_6.setText(Integer.toString(rand.nextInt(60)+1)); //MAX 31
...
//            startActivity(intent);
            Intent myIntent = new Intent(Trudny.this, Sredni2.class);
