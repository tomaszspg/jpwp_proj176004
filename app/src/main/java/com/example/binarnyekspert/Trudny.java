...
/**
 * Klasa poziomu 1 trybu trudnego binarnego, zawiera całą mechanikę gry
...
public class Trudny extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt1_6.setText(Integer.toString(rand.nextInt(32)+1)); //MAX 31
        bt2_6.setText(Integer.toString(rand.nextInt(32)+1));
        bt3_6.setText(Integer.toString(rand.nextInt(32)+1));
        bt4_6.setText(Integer.toString(rand.nextInt(32)+1));
        bt5_6.setText(Integer.toString(rand.nextInt(32)+1));
        bt6_6.setText(Integer.toString(rand.nextInt(32)+1));
