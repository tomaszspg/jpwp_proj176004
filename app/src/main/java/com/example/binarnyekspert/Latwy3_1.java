...
/**
 * Klasa poziomu 1 trybu łatwego trójkowego, zawiera całą mechanikę gry
 * przekazuje zmienną z punktami do kolejnej aktywności poziomu 2*/
public class Latwy3_1 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_latwy3_1);
...
//                    , "Git jest", Toast.LENGTH_LONG).show();
        ...
        if (licznik==5)
        {
            ...
            Intent myIntent = new Intent(Latwy3_1.this, Latwy3_2.class);
