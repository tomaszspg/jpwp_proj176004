...
/**
 * Klasa poziomu 2 trybu łatwego trójkowego, zawiera całą mechanikę gry
...
public class Latwy3_2 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt1_6.setText(Integer.toString(rand.nextInt(60)+1)); //MAX 80
        bt2_6.setText(Integer.toString(rand.nextInt(60)+1));
        bt3_6.setText(Integer.toString(rand.nextInt(60)+1));
        bt4_6.setText(Integer.toString(rand.nextInt(60)+1));
        bt5_6.setText(Integer.toString(rand.nextInt(60)+1));
