...
/**
 * Klasa poziomu 2 trybu średniego binarnego, zawiera całą mechanikę gry
 * pobiera zmienną z punktami z poziomu 1 i przekazuje do kolejnej aktywności poziomu 3 z dodanymi punktami za ten poziom */
public class Sredni2 extends AppCompatActivity implements View.OnClickListener {
...
//    int intValue= exBundle.getInt("intValue");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sredni2);
        ...
        bt1_6.setText(Integer.toString(rand.nextInt(24)+1)); //MAX 31
        bt2_6.setText(Integer.toString(rand.nextInt(24)+1));
        bt3_6.setText(Integer.toString(rand.nextInt(24)+1));
        bt4_6.setText(Integer.toString(rand.nextInt(24)+1));
        bt5_6.setText(Integer.toString(rand.nextInt(24)+1));
...
//                    , "Git jest", Toast.LENGTH_LONG).show();
        ...
        if (licznik==5)
        {
            ...
            Intent myIntent = new Intent(Sredni2.this, Sredni3.class);
