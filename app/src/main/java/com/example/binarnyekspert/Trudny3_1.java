...
/**
 * Klasa poziomu 1 trybu trudnego trójkowego, zawiera całą mechanikę gry
 * przekazuje zmienną z punktami do kolejnej aktywności poziomu 2*/
public class Trudny3_1 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trudny3_1);
...
//            startActivity(intent);
            Intent myIntent = new Intent(Trudny3_1.this, Trudny3_2.class);
