...
/**
 * Klasa poziomu 2 trybu trudnego trójkowego, zawiera całą mechanikę gry
...
public class Trudny3_2 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt1_6.setText(Integer.toString(rand.nextInt(520)+1)); //MAX 728
        bt2_6.setText(Integer.toString(rand.nextInt(520)+1));
        bt3_6.setText(Integer.toString(rand.nextInt(520)+1));
        bt4_6.setText(Integer.toString(rand.nextInt(520)+1));
        bt5_6.setText(Integer.toString(rand.nextInt(520)+1));
        bt6_6.setText(Integer.toString(rand.nextInt(520)+1));
        ...
        new CountDownTimer(duration, 1000) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                punkt2.setText(String.valueOf(11-(pktrz2/2)));
            }
