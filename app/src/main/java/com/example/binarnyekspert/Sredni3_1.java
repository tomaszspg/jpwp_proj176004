...
/**
 * Klasa poziomu 1 trybu średniego trójkowego, zawiera całą mechanikę gry
 * przekazuje zmienną z punktami do kolejnej aktywności poziomu 2*/
public class Sredni3_1 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sredni3_1);
        ...
        bt1_6.setText(Integer.toString(rand.nextInt(81)+1)); //MAX 242
        bt2_6.setText(Integer.toString(rand.nextInt(81)+1));
        bt3_6.setText(Integer.toString(rand.nextInt(81)+1));
        bt4_6.setText(Integer.toString(rand.nextInt(81)+1));
        bt5_6.setText(Integer.toString(rand.nextInt(81)+1));
...
//            startActivity(intent);
            Intent myIntent = new Intent(Sredni3_1.this, Sredni3_2.class);
